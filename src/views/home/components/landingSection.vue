<template>
     <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img src="../../../assets/img/logo1.svg" alt="" width="120" /></a>
        <!-- <span class="text-1000 fs-1 ms-2 fw-medium">Lasles<span class="fw-bold">VPN</span></span>< -->
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
              <li class="nav-item mr-4"><a class="nav-link active active" aria-current="page" href="#">Home</a></li>
              <li class="nav-item mr-4"><a class="nav-link" href="#">Service</a></li>
              <li class="nav-item mr-4"><a class="nav-link" href="#">Portfolio </a></li>
              <li class="nav-item mr-4"><a class="nav-link" href="#">About</a></li>
            </ul>
            <!-- <form class="d-flex py-3 py-lg-0">
              <button class="btn btn-outline-danger rounded-pill order-0" type="submit">Get Quat</button>
            </form> -->
          </div>
        </div>
      </nav>
      ...
      <section class="pb-6">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="../../../assets/img/cover.png" alt="" /></div>
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              <h1 class="fw-medium">Want anything to be<br />easy with <span class="fw-bold">Infocliq.net.</span></h1>
              <p class="mt-3 mb-4">Provide a network for all your needs with ease and fun using <span class="fw-medium">LaslesVPN </span>discover interesting features from us.Most people make the mistake of forcing themselves to network.Or they pretend to be outgoing to make new connections. </p>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section class="pt-4 pt-md-6">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 text-lg-center"><img class="img-fluid mb-5 mb-md-0" src="../../../assets/img/product.png" alt="" /></div>
      ...
      <section class="bg-200 pt-9 pb-0">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 mb-3">infocliq.net
              <p class="my-3"> <span class="fw-medium">infocliq </span>is a private virtual network that<br />has unique features and has high security. </p>
              ...
              <p class="text-400 my-3">&copy; 2021 infocliq.net</p>
            </div>
            <div class="col-6 col-sm-4 col-lg-3 mb-3">
              <h5 class="lh-lg">product </h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">Home</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">Products</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">Portfolio</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-4 col-lg-3 mb-3">
